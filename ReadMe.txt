...
Users can perform different translocation simulations (D,E and F) under the respective simulation directories. Fixed-size simulation will create a 2D Hi-C matrices.
